...
const AddNewCity = () => {
  ...
  const handleAddCity = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        await setVisible(6)
        setSuccessAdd(i18n.language == 'ar' ? "تمت اضافة مدينة بنجاح" : "New City Added Successfuly")
          ...
          <CCardHeader>
            <CRow className=" row-gap-15">
              ...
              <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                <strong>{i18n.language == 'ar' ? "إضافة مدينة جديدة" : "Add New City"}</strong>
              </CCol>
                  ...
                  <CCard>
                    <CCardBody>
                      <CRow >
                        ...
                        <CCol md='12'> <strong>{i18n.language == 'ar' ? `معلومات المدبنة :` : `City Informations :`}</strong></CCol>
